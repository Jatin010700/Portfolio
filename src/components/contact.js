...
export const Contact = () => {
  return (
    <>
      ...
      <h1 className="font-bold text-4xl md:text-8xl mb-10 w-full text-center text-dark">
      <AnimatedText text="Get in Touch!" className="" />
        ...
        <div className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-white p-8">
          <div className="absolute top-0 -right-2 -z-10 w-[102%] h-[105%] rounded-2xl bg-dark" />
